...
| 5.9 | Recovery Targets, Timelines, and Recovery Control | NEXT |
...
Part 5.9 — Recovery Targets, Timelines, and Recovery Control → Draft + Hands-On Lab (`labs/recovery-target-check.sql`).
